    ...
    with open(jsonl_file_path, 'r', encoding='utf-8') as jsonl_file:
        for line in jsonl_file:
            ...
            if questions:
                ...
                # 获取选中问题的文本
                question_text = selected_question.get('text', '')
                # 获取选中问题的标签作为答案
                question_label = selected_question.get('label', None)
...
if __name__ == '__main__':
    jsonl_file_path = r'C:\Users\24838\Desktop\datasets\ruletaker\test.jsonl'  # 输入的JSONL文件路径
    json_file_path = r'ruletaker\json\val.json'   # 输出的JSON文件路径
    npy_file_path = r'ruletaker\npy\val.npy'
